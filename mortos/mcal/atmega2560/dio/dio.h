...
/*!
 *  \def	PORTH
 *  \brief	Output Register of Port H
 */
#define PORTH	REG(0x102)

/*!
 *  \def	DDRH
 *  \brief	Data Direction Register of Port H
 */
#define DDRH	REG(0x101)

/*!
 *  \def	PINH
 *  \brief	Input Register of Port H
 */
#define PINH	REG(0x100)
